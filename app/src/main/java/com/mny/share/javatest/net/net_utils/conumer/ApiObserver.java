...
import com.mny.share.javatest.net.net_utils.exception.ErrorControl;
 ...
 */
public abstract class ApiObserver<T> implements Observer<T> ,ErrorDefinInterface{
    Context context;
    ...
    public void onSubscribe(Disposable d) {
        if (!NetworkUtils.isConnected()) {
            this.onError(new ApiException(ErrorControl.CONNECT_ERROR, "网络链接异常"));
        }
    }
